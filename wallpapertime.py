...
class WallpaperTimeApp(QMainWindow):
    def __init__(self):
        ...
        self.checkbox_update_thread = threading.Thread(
            target=self.continuously_update_checkbox_states
        )
        self.checkbox_update_thread.daemon = (
    ...
    def update_interval_table(self):
        self.interval_table.clearContents()  # Очистим содержимое перед обновлением
